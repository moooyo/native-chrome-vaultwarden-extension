...
import type { CipherInput, CipherSummary, CollectionSummary, DecryptedCipher, FieldName, FolderSummary, PasskeyTarget, PasskeyCandidate, TotpListEntry } from '../core/vault/models.js';
...
export type RequestMessage =
  ...
  | { type: 'vault.getPasskeyCandidates'; rpId: string; origin: string; allowedCredentialIds?: string[] }
...
export type ResponseMessage =
  ...
  | { ok: true; data: { totpEntries: TotpListEntry[] } }
  ...
  | { ok: true; data: { candidates: PasskeyCandidate[] } }
