...
function ChromeToolbar({ url = 'example.com', extra }) {
  const iconDot = (
    <div style={{
...
function ChromeWindow({
  ...
  width = 900, height = 600, toolbarExtra, contentBg = '#fff', children,
}) {
  return (
    <div style={{
      ...
      <ChromeToolbar url={url} extra={toolbarExtra} />
      <div style={{ flex: 1, background: contentBg, overflow: 'hidden', position: 'relative' }}>
        {children}
      </div>
    </div>
  );
